...
const CONFLICT_ADVICE = {
  ...
  "Honesty-Humility": {
    title: "The Idealist vs. The Pragmatist",
    highA: "Partner A values authenticity and modesty highly, while Partner B is more comfortable with self-promotion and strategic behavior.",
    highB: "Partner B values authenticity and modesty highly, while Partner A is more comfortable with self-promotion and strategic behavior.",
    advice: "The idealist should try to understand that strategic behavior isn't always dishonesty — sometimes it's social intelligence. The pragmatist should recognize that the idealist's standards come from deep values, not naivety.",
    deepDive: "This difference can create trust issues. The idealist may see the pragmatist as 'manipulative,' while the pragmatist may see the idealist as 'naive.' Finding shared values — what you BOTH believe is non-negotiable — creates common ground.",
  },
  "HEXACO Agreeableness": {
    title: "The Forgiver vs. The Scorekeeper",
    highA: "Partner A forgives easily and moves on quickly, while Partner B holds onto grievances longer.",
    highB: "Partner B forgives easily and moves on quickly, while Partner A holds onto grievances longer.",
    advice: "The 'forgiver' should acknowledge that the 'scorekeeper' remembers because they care — past wounds signal unresolved needs. The 'scorekeeper' should try to voice concerns when they arise, rather than accumulating them into a mental ledger.",
    deepDive: "Unaddressed, this pattern becomes: the forgiver feels exhausted by 'old arguments' resurfacing, while the scorekeeper feels unheard. A monthly 'emotional check-in' — where both partners share what's been on their mind — can prevent buildup.",
  },
};
