...
export function generateGrowthTips(results) {
  ...
  if (results.gottman) {
    tips.push({
      ...
      emoji: "⚡",
      trait: results.gottman.style,
      content: getGottmanGrowthTip(results.gottman.style),
    });
  }
...
function getGottmanGrowthTip(style) {
  const tips = {
    "Validating": "Your calm approach is a strength. Just make sure you aren't avoiding necessary passionate disagreements for the sake of keeping the peace.",
    "Volatile": "Your passion brings energy. Practice 'soft startups' during arguments to ensure your intensity doesn't overwhelm your partner or escalate into criticism.",
    "Conflict-Avoiding": "Peace is good, but unspoken resentments can build. Challenge yourself to bring up one minor issue this week and practice discussing it constructively.",
    "Hostile": "Notice when you feel defensive. Take a 20-minute break when you feel 'flooded' with emotion, and practice expressing your needs without criticizing your partner.",
    "Hostile-Detached": "Emotional withdrawal (stonewalling) damages connection. Practice recognizing when you are shutting down and communicate: 'I need a break, but I will come back to this.'",
  };
  return tips[style] || "Awareness of your conflict style allows you to communicate more effectively under stress.";
}
